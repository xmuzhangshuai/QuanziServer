...
@WebServlet(name="getMsgServlet",urlPatterns="/user/getMsg")
public class UserGetMsgServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pageNow<0){
			...
			HashMap<String,Object> result = uImpl.getMsg(userid,pageNow);	
