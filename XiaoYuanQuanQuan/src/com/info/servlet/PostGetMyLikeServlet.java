...
@WebServlet(name="postGetMyLikeServlet",urlPatterns="/post/getMyLike")
public class PostGetMyLikeServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = pImpl.getLikePosts(user_id);
