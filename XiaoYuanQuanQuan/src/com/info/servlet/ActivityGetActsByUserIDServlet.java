...
@WebServlet(name="getActsByUserIDServlet",urlPatterns="/activity/getActsByUserID")
public class ActivityGetActsByUserIDServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = aImpl.getActsByUserID(userid);
