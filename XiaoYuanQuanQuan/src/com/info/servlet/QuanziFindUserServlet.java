...
@WebServlet(name="quanziFindUserServlet",urlPatterns="/quanzi/findUser")
public class QuanziFindUserServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.findUserByTel(c_userid, tel);
