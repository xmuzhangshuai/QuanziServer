...
@WebServlet(name="quanZiGetSkillListServlet",urlPatterns="/quanzi/getSkillList")
public class QuanziGetSkillListServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.getSkillList();
