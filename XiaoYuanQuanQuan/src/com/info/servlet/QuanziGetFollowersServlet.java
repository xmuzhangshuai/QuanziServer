...
@WebServlet(name="getFollowersServlet",urlPatterns="/quanzi/getFollowersByIndustryID")
public class QuanziGetFollowersServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String i_industry_item = request.getParameter(IndustryTable.I_NAME);
		HashMap<String,Object> result = qImpl.getFollowersListByIndustry(userid, i_industry_item);
