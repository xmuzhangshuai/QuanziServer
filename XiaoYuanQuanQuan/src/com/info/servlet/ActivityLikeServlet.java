...
@WebServlet(name="likeActivityServlet", urlPatterns="/activity/like")
public class ActivityLikeServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int a_id = Integer.parseInt(request.getParameter(ActivityTable.A_ACTID));
		int user_id = Integer.parseInt(request.getParameter(ActivityTable.A_USERID));
		int like_user_id = Integer.parseInt(request.getParameter(UserTable.U_ID));
		
		HashMap<String,Object> result = aImpl.likeActivity(a_id, user_id, like_user_id);
