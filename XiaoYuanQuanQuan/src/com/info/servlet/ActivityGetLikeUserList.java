...
@WebServlet(name="getActLikeUserListServlet",urlPatterns="/activity/getLikeUserList")
public class ActivityGetLikeUserList extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	out.print(0);
		//}else{
			HashMap<String,Object> result = aImpl.getLikeUserList(act_id, act_user_id/*, pageNow*/);		 	
