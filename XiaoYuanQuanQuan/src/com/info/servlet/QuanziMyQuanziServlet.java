...
@WebServlet(name="quanziMyQuanziServlet",urlPatterns="/quanzi/myQuanzi")
public class QuanziMyQuanziServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.getMyConcernsIndustry(c_userid);
