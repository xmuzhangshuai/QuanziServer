...
@WebServlet(name="getMyNewFollowersServlet",urlPatterns="/quanzi/getMyNewFollowers")
public class QuanziGetMyNewFollowersServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.getMyNewFollowers(userid);
