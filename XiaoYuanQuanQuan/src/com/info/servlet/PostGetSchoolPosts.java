...
@WebServlet(name="getSchoolPostsServlet",urlPatterns="/post/getSchoolPosts")
public class PostGetSchoolPosts extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("u_love_state=" + u_love_state);
		...
		if(pageNow < 0)
			...
			HashMap<String,Object> result = pImpl.getSchoolPosts(school_id, pageNow, userid, filter);
