...
@WebServlet(name="quanziMyFollowerServlet",urlPatterns="/quanzi/myFollower")
public class QuanziMyFollowerServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.getMyFollowersIndustry(c_userid);
