...
@WebServlet(name="undoConcernServlet",urlPatterns="/quanzi/undoConcern")
public class QuanziUndoConcernServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.undoConcern(c_userid, c_beconcerned_userid);
