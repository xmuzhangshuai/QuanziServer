...
@WebServlet(name="getActCommentsServlet",urlPatterns="/activity/getComments")
public class ActivityGetCommentsServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(pageNow < 0)
			...
			HashMap<String,Object> result = aImpl.getActComments(a_actid, a_userid, pageNow);
