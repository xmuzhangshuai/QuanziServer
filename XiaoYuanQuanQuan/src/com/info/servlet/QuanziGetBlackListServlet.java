...
@WebServlet(name="quanZiGetBlackListServlet",urlPatterns="/quanzi/getBlackList")
public class QuanziGetBlackListServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.getBlackList(userid);
