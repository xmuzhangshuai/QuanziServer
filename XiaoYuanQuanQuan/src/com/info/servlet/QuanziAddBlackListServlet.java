...
@WebServlet(name="quanZiAddBlackListServlet",urlPatterns="/quanzi/addBlackList")
public class QuanziAddBlackListServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int bl_userid = Integer.parseInt(request.getParameter(BlackListTable.BL_USERID));
		int bl_shielder_userid = Integer.parseInt(request.getParameter(BlackListTable.BL_SHIELDERID));
		
		HashMap<String,Object> result = qImpl.addBlackList(bl_userid, bl_shielder_userid);
