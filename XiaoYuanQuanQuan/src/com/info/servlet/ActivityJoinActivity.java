...
@WebServlet(name="activityJoinServlet",urlPatterns="/activity/join")
public class ActivityJoinActivity extends HttpServlet{
	/**
	 * 
	 */
...
//		String report_reason = request.getParameter(PostReportTable.PR_REPORT_REASON);
		...
		HashMap<String,Object> result = aImpl.joinActivity(a_actid, a_userid, a_apply_userid);
