...
@WebServlet(name="postsContainCommentsServlet",urlPatterns="/post/getPostsContainComments")
public class PostGetPostsContainComments extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = pImpl.getPostsContainComments(school_id, pageNow);
