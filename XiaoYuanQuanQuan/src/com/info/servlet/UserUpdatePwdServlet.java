...
@WebServlet(name="updatePwdServlet",urlPatterns="/user/updatePwd")
...
//		QuanziServiceImpl qImpl = new QuanziServiceImpl(dtMapper);
		...
		String oldPwd = request.getParameter(UserTable.U_PASSWORD);
		
		HashMap<String,Object> result = uImpl.updatePassword(newPwd, userid, oldPwd);
