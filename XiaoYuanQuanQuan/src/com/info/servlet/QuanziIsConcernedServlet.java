...
@WebServlet(name="isConcernedServlet",urlPatterns="/quanzi/isConcerned")
public class QuanziIsConcernedServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> result = qImpl.isConcern(c_userid, c_beconcerned_userid);
