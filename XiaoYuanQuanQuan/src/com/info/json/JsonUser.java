...
public class JsonUser {
	...
	public JsonUser(HashMap<String,Object> user){
		...
		this.u_industry_item = (String) user.get("u_industry_item");
		this.u_interest_items = (String) user.get("u_interest_items");
		...
		this.u_skill_items = (String)user.get("u_skill_ids");
