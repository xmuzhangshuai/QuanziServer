...
public class JsonPostItemContainComments {
	private int p_id;
	...
	private List<JsonPostComment> comments;

	public JsonPostItemContainComments() {
		super();
	...
	public List<JsonPostComment> getComments() {
		return comments;
	}

	public void setComments(List<JsonPostComment> comments) {
