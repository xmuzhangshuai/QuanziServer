...
public class NarrowImage {
	...
	public static BufferedImage zoomImage(String src, float resizeTimes) {
	 ...
	 public static void narrowImage(String input, float resizeTimes, String output){
		 NarrowImage.writeHighQuality(NarrowImage.zoomImage(input,resizeTimes), output);
	 }
